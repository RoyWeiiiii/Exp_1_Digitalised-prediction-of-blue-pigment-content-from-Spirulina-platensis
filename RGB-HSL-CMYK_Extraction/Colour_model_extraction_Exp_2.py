...
def calculate_color_attributes(image_path, cpc_concentration):
    try:
        ...
        return {
            ...
            'Day': "16"  # Specify the desired Day value here
        }
...
if __name__ == "__main__":
    ...
    input_folders = [
        {
            'folder': "E:\CodingProjects\machine_learning\Experiment 2\Bg-11\Day_16_BG-11\Online_Crop_Batch_1_X100",
            'cpc_concentration': '0.2020'
        },
        {
            'folder': "E:\CodingProjects\machine_learning\Experiment 2\Bg-11\Day_16_BG-11\Online_Crop_Batch_2_X100",
            'cpc_concentration': '0.2451'
        },
        {
            'folder': "E:\CodingProjects\machine_learning\Experiment 2\Bg-11\Day_16_BG-11\Online_Crop_Batch_3_X100",
            'cpc_concentration': '0.2430'
        }
    ]

    # Specify the output CSV file path
    output_csv_file = "E:\CodingProjects\machine_learning\Experiment 2\Bg-11\Day_16_BG-11/Combine_Batch_Day_16_BG_200_IMG.csv"
    ...
    for batch_info in input_folders:
        ...
        batch_number = os.path.basename(batch_info['folder']).replace("Online_Crop_Batch_1_X100", "1") \
            .replace("Online_Crop_Batch_2_X100", "2").replace("Online_Crop_Batch_3_X100", "3")
